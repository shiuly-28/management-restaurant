  ...
  return (
    <div className=" py-12 px-4 lg:px-8">
      <div className="max-w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
        ...
        {/* ✅ Left Side - Image */}
        <div className="flex justify-center border border-transparent hover:border-green-500 p-5 rounded-2xl" data-aos="fade-up-right">
          <img
        ...
        {/* ✅ Right Side - Content */}
        <div className="space-y-6 text-center lg:text-left border border-transparent hover:border-green-500 p-5 rounded-2xl" data-aos="fade-up-left">
          ...
          <div className="pt-4">
            <h3 className="text-2xl font-bold mb-1">Parvez Hossain Imon</h3>
